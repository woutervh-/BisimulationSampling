...
{
    class EstimateBisimulationWorker<TNode, TLabel> : AbstractMachine
    {
        /// <summary>
        /// The graph.
        /// </summary>
        ...
        /// Owner function.
        /// </summary>
        private IDictionary<TNode, EstimateBisimulationWorker<TNode, TLabel>> owner;

        /// <summary>
        /// Inverted owner function.
        /// </summary>
        private IDictionary<EstimateBisimulationWorker<TNode, TLabel>, HashSet<TNode>> ownerInverted;

        /// <summary>
        /// Interested-in function.
        /// </summary>
        private Dictionary<EstimateBisimulationWorker<TNode, TLabel>, HashSet<TNode>> interestedIn;
        ...
        /// <returns></returns>
        public static EstimateBisimulationWorker<TNode, TLabel>[] CreateWorkers(MultiDirectedGraph<TNode, TLabel> graph, IDictionary<TNode, int> partition)
        {
            ...
            var workers = new EstimateBisimulationWorker<TNode, TLabel>[counter];
            for (int i = 0; i < counter; i++)
            {
                workers[i] = new EstimateBisimulationWorker<TNode, TLabel>();
                workers[i].setGraph(graph);
            }

            var owner = new Dictionary<TNode, EstimateBisimulationWorker<TNode, TLabel>>();
        ...
        /// Private constructor.
        /// </summary>
        private EstimateBisimulationWorker()
        {
            //
        }
        ...
        private void setOwner(IDictionary<TNode, EstimateBisimulationWorker<TNode, TLabel>> owner)
        {
            this.owner = owner;
            this.ownerInverted = Utils.Invert(owner);
            this.interestedIn = new Dictionary<EstimateBisimulationWorker<TNode, TLabel>, HashSet<TNode>>();
